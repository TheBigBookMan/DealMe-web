...
const LocationDealsPopup = ({
    ...
    const getLocationOptions = (search) => {
        const dealsLocations = [];

        deals.forEach((deal) => {
            if (search === "init") {
                if (
                    dealsLocations.includes(deal.business.suburb.toLowerCase())
                ) {
                    return;
                } else {
                    dealsLocations.push(deal.business.suburb.toLowerCase());
                }
            } else {
                if (
                    dealsLocations.includes(deal.business.suburb.toLowerCase())
        ...
        setLocationSelection(dealsLocations);
    };
...
export default LocationDealsPopup;
